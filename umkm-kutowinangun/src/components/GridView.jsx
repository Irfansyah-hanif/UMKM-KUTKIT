      ...
      {filteredUmkm.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredUmkm.map((umkm, idx) => {
            // Memprioritaskan kelompokUsaha agar badge sinkron dengan dropdown opsi yang dipilih
            const labelKategori = umkm.kelompokUsaha || umkm.kategori || 'UMKM';
            ...
            return (
              ...
              >
                <div className="relative h-48 overflow-hidden bg-sky-50">
                  ...
                  {/* BADGE KATEGORI SINKRON (Menampilkan KULINER / PERDAGANGAN / JASA / KONVEKSI dll.) */}
                  <div className="absolute top-3 left-3 flex gap-1.5 flex-wrap">
                    <span className="text-[11px] font-extrabold px-2.5 py-1 rounded-lg backdrop-blur-md bg-white/90 text-sky-800 border border-sky-100 shadow-xs uppercase tracking-wider">
                      {labelKategori}
                    </span>
                  </div>
                ...
                <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                  ...
                  <div className="space-y-3 pt-2 border-t border-sky-100">
                    ...
                    {/* Action Group: Detail (Publik) + Edit & Hapus (Admin) */}
